...
userSchema.plugin(findOrCreate);                                 //6
...
passport.serializeUser(function(user, done) {                 //9
    done(null, user.id);
  });
...
passport.use(new GoogleStrategy({                                //2  
    clientID: process.env.CLIENT_ID,
    clientSecret: process.env.CLIENT_SECRET,
    callbackURL: "http://localhost:3000/auth/google/secrets",           //4
    userProfileURL: 'https://www.googleapis.com/oauth2/v3/userinfo'   //3
  },
